    ...
    function drawSubunits( data ) {
        ...
        geo.enter()
            ...
            .attr("fill", function (d) {
                if (colorCodeData[d.id] != null && colorCodeData[d.id].fillAttr != null) {
                    return fillData[colorCodeData[d.id].fillAttr]
                }
                return "";
            })
        ...
        for ( var subunit in data ) {
            if ( data.hasOwnProperty(subunit) ) {
                ...
                svg
                    ...
                    .transition()
                    .style('fill', color)
                    .attr("fill", subunitData.fillAttr)
                    .attr('class', function(d) {
                        var className = subunitData.className;
                        return 'datamaps-subunit ' + d.id + " "+ className;
                    });
            }
        }
    };
